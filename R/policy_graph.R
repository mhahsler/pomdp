...
#' @param belief logical; calculate belief proportions and show them as a pie chart in each node of
#' the graph?
#' @param col colors used for the states in the belief proportions.
#' @param ... if `belief = TRUE`, then additional parameters are passed on for belief point 
#'   sampling with [sample_belief_space()] or [simulate_POMDP()]. 
