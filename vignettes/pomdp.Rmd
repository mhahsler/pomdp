---
title: "Getting Started with pomdp"
author: "Michael Hahsler and Hossein Kamalzadeh"
bibliography: references.bib
vignette: >
  %\VignetteIndexEntry{Getting Started with pomdp}
...
The `POMDP()` function has the following arguments, each of which corresponds to
...
> reset (i.e., the tiger is randomly assigned to a door with a 50/50
> chance), and the agent gets another try.

## Specifying the Tiger Problem

The problem can be specified using the `POMDP()` function as follows.
