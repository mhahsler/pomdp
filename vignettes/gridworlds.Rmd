---
title: "Gridworlds in pomdp"
author: "Michael Hahsler"
bibliography: references.bib
vignette: >
  %\VignetteIndexEntry{Gridworlds in pomdp}
...
animation_display <- if (has_gifski) "animate" else "last"
...
if (has_gifski) {
  chunk_options$animation.hook <- knitr::hook_gifski
}
...
with given dimensions. Unreachable states and absorbing states can be defined.
...
```
When `gifski` is installed, R Markdown combines the individual frames into an
animation. Otherwise, the vignette displays the final frame as a static plot.

```{r, fig.show=animation_display}
